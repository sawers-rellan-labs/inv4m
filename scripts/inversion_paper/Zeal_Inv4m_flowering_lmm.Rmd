...
in the ZEAL NIL panel grown at NC2025 (raw data: `data/CLY25_ZEAL.csv`,
...
p_per_race <- ggplot(zeal_long_race,
  ...
  labs(x = NULL, y = NULL,
       ...
       subtitle = "NC2025 ZEAL NIL panel; FDR adjusted per ancestry emmeans contrast (5 ancestry family per trait)") +
...
p_forest <- ggplot(results_tbl,
  ...
  labs(
    ...
    y = NULL,
    title    = "Inv4m accelerates flowering in the ZEAL NIL panel",
...
ggsave(file.path(paths$figures, "inv4mZEAL.png"),
       panel_supp, width = 11, height = 4.6, dpi = 300)
ggsave(file.path(paths$figures, "inv4mZEAL.svg"),
