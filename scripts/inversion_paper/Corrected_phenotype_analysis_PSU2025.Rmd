---
title: "PA2025 — Spatial analysis (statgenHTP + SpATS) with GDD integration"
...
if (!file.exists(pheno_file)) {
  stop("PSU2025_pheno2.csv not found in: ", paths$data,
       "\nPlease copy this file to the data directory.")
}
if (!file.exists(meta_file)) {
  stop("PSU2025_metadata.csv not found in: ", paths$data,
       "\nPlease copy this file to the data directory.")
}
```
...
## 1. Read + tidy (produce plot-level table matching PA2025 column names)
...
if (exists("sp_corrected") && nrow(sp_corrected) > 0) {
  ...
  output_filename <- file.path(paths$intermediate,
