...
make_panel <- function(genome_id, show_points = FALSE, bot_margin = 15) {
  ...
  p <- ggplot() +
    ...
    { if (genome_id == "B73")
        geom_vline(xintercept = c(158e6, 191e6),
                   color = "black", linewidth = lw, linetype = "dashed") } +
    { if (genome_id == "Mi21")
        geom_vline(xintercept = c(156.93e6, 186.33e6),
                   color = "black", linewidth = lw, linetype = "dashed") } +
    { if (show_points)
...
variant_mi21 <- list(
  ...
  genome_labels = list(
    ...
    list(name = "B73",   y = 0.3539, desc = NULL)),
  introgression = list(mi21_left = 156.93, mi21_right = 186.33,
                       b73_left  = 158.0,  b73_right  = 191.0))
```
...
introg_mi21 <- c(140.8, 170.2)  # Mi21 Mb (x-axis)
introg_b73  <- c(158.0, 191.0)  # B73 Mb  (y-axis)
