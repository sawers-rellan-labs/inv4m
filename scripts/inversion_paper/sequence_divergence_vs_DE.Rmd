...
'\\textbf{Figure X.} CDS sequence divergence and expression change in the \\invfour
introgression.
\\textbf{(A)} Distribution of CDS divergence (100 $-$ \\% identity) for expressed genes
inside the inversion (\\invfour, $n$ = ', n_inv4m, ') and in
the flanking introgression (flanking, $n$ = ', n_flank, ').
...
Parallel lines show the additive ANCOVA model (shared slope for divergence effect,
vertical offset for region effect).
Region $p$ = ', add_p_loc, ';
divergence $p$ = ', add_p_div, ';
adj.\\ $R^2$ = ', add_r2, '.')
