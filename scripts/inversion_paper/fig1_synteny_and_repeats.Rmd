---
title: "Chromosomal Knob Repeat Analysis — Figure 1 Panels B–D"
author: "inv4m"
date: "`r Sys.Date()`"
output:
  html_document:
...
# Panel D: Breakpoint self-similarity dotplots
...
# Panel C: Inv4m chromosome 4 dotplots (Mi21 vs references)
...
# Combined layout: Panels B + C + D

Assemble the three panels side by side. Panel B (repeat annotation) is wide,
Panel C (AnchorWave dotplots) is narrow, Panel D (breakpoint dotplots) is
...
build_fig1_top <- function(show_points) {
  ...
  label_y <- 0.965
  ggdraw(fig1_grid) +
    draw_label("B", x = 0.005, y = label_y, size = 32, fontface = "bold",
               hjust = 0.2, vjust = 1) +
    draw_label("C", x = 0.56,  y = label_y, size = 32, fontface = "bold",
               hjust = 0.2, vjust = 1) +
    draw_label("D", x = 0.71,  y = label_y, size = 32, fontface = "bold",
               hjust = 0.2, vjust = 1)
}
