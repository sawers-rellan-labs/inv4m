...
```{r export_go_enrichment_files}
# Generate trans_network_edges_annotated.csv with regulator_region column
# This file is required by GO_Enrichment_Trans_Network.Rmd
...
trans_network_edges_annotated <- bipartite_edges %>%
  ...
  dplyr::select(from, to, r, in_maizenetome, network_module, regulator_region)
...
# Generate trans_network_regulators.csv
...
cat("Total regulators:", nrow(trans_network_regulators), "\n")
cat("By region:\n")
print(table(trans_network_regulators$region))

# Generate trans_network_targets.csv
...
cat("Total targets:", nrow(trans_network_targets), "\n")

# Generate trans_network_all_genes.csv
