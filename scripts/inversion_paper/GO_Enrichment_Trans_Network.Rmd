...
trans_regulators <- read.csv(file.path(paths$intermediate, "trans_network_regulators.csv"))
trans_targets <- read.csv(file.path(paths$intermediate, "trans_network_targets.csv"))
trans_network_all <- read.csv(file.path(paths$intermediate, "trans_network_all_genes.csv"))
trans_edges <- read.csv(file.path(paths$intermediate, "trans_network_edges_annotated.csv"))
