...
go_panel <- readRDS("~/Desktop/figure_panels/go_panel.rds")
cat("Loaded GO panel\n")

# Load KEGG enrichment plot
kegg_panel <- readRDS("~/Desktop/figure_panels/kegg_panel.rds")
cat("Loaded KEGG panel\n")

# Load LION enrichment plot
lion_panel <- readRDS("~/Desktop/figure_panels/lion_plot.rds")
...
ggsave(
  combined_fig_v1,
  filename = "~/Desktop/combined_enrichment_figure.svg",
  width = 16,
  height = 16,
  units = "in"
)
...
go_data_exists <- file.exists("~/Desktop/figure_panels/go_plot_input_data.csv")
kegg_data_exists <- file.exists("~/Desktop/figure_panels/kegg_plot_input_data.csv")
lion_data_exists <- file.exists("~/Desktop/figure_panels/lion_plot_input_data.csv")
