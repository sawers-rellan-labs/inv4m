...
# Export CSV files (remove list columns if present)
...
# Remove list columns from t-test results before export
...
# Export genotype comparison statistics (remove list columns)
