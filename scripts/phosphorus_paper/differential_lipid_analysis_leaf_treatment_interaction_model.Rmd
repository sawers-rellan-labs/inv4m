...
write.csv(
  label_data,   
  file ="~/Desktop/high_confidence_DLs.csv"
)
...
# Save growth curve plots
saveRDS(lipid_volcano_3, "../results/lipid_volcano_3.rds")
...
ggsave(
  filename = "~/Desktop/volcano_2_leafxP.png",
  plot = volcano_2,
  height = 3,
  width = 5,
  units = "in",
...
ggsave(
  filename = "~/Desktop/volcano_leafP.png",
  plot = volcano_leafP,
  height = 7,
  width = 7,
  units = "in",
...
write.csv(
  voomR$E,
  file = "~/Desktop/voom_normalised_lipids.csv",
  row.names = TRUE
)
...
write.csv(
  effects_df,
  file = "~/Desktop/lipid_differential_abundance_results.csv",
  row.names = FALSE
)
...
writeLines(latex_table, con = "~/Desktop/differential_lipids_table.tex")

cat("✅ Final lipid table (4 columns, no Notes) saved to: ~/Desktop/differential_lipids_table.tex\n")
```
# Session Information
