...
write.csv(
  kegg_plot_data,
  file = "~/Desktop/figure_panels/kegg_plot_input_data.csv",
  row.names = FALSE
)
...
saveRDS(
  annotation_plot,
  file = "~/Desktop/figure_panels/kegg_panel.rds"
)

ggsave(
  annotation_plot,
  file = "~/Desktop/figure_panels/kegg_panel.pdf",
  height = 7,
  width = 16
)
...
ggsave(
  annotation_plot,
  file = "~/Desktop/HC_DEG_KEGG_annotation.svg",
  height = 7,
  width = 12,
  dpi = 150
)
