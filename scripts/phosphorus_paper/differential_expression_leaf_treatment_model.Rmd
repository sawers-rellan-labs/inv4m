...
```{r load_metadata}
sampleInfo <- read.csv(file.path(paths$data, "PSU-PHO22_Metadata.csv"))
...
saveRDS(voomR$E, file = file.path(paths$intermediate, "normalized_expression_logCPM_leaf_trt.rda"))
saveRDS(voomR, file = file.path(paths$intermediate, "normalized_expression_voom_object_leaf_trt.rda"))
...
voomR <- readRDS(file.path(paths$intermediate, "normalized_expression_voom_object_leaf_trt.rda"))
