...
```{r save_supplementary, eval=FALSE}
ggsave(
  final_combined,
...
write.csv(
  minusP_0016036,
  file = "~/Desktop/minusP_0016036_genes.csv"
) 
...
gene_data <- read.csv("~/Desktop/minusP_0016036_genes.csv", row.names = NULL)
...
writeLines(
  latex_gene_table, 
  con = "~/Desktop/minusP_genes_table.tex"
)

cat("✅ Gene LaTeX table saved to: leaf_p_interaction_genes_table.tex\n")
cat("✅ Gene LaTeX table saved to: lminusP_genes_table.tex\n")
```
