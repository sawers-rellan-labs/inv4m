...
if (file.exists("../results/plot_growth_params.rds")) {
  p_gc <- readRDS("../results/plot_growth_params.rds")
  cat("Loaded growth parameter plot\n")
} else {
  warning("Growth parameter plot not found. Run PSU2022_growthcurves.Rmd first.")
}

if (file.exists("../results/plot_fitted_curves.rds")) {
  p_fitted <- readRDS("../results/plot_fitted_curves.rds")
...
ggsave("~/Desktop/supp_global_fdr.png", supp_global_fdr_plot, 
