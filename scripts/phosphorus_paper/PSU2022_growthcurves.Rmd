...
brackets_d <- read.csv(file.path(paths$intermediate,
                                  "PSU2022_fig1_bracket_contrasts.csv"))
...
if (length(other_traits_viz) > 0) {
  ...
  cat("\n=== Approach D contrast summary (non-growth traits) ===\n")
  print(
    as_tibble(treatment_pairwise) %>%
...
print(
  as_tibble(treatment_timeseries_test) %>%
