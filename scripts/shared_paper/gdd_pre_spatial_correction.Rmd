...
# Also get inversion_paper paths for output (GDD lookup used by spatial correction)
...
gdd_lookup_output <- file.path(paths_inv$intermediate, "gdd_lookup_table.csv")
