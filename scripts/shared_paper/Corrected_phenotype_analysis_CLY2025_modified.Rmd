...
# Also get inversion_paper paths for GDD lookup if needed
paths_inv <- setup_project_paths("inversion_paper")
```
...
gdd_lookup_file <- file.path(paths_inv$intermediate, "gdd_lookup_table.csv")
...
if (exists("sp_corrected") && nrow(sp_corrected) > 0) {
  ...
  output_file <- file.path(paths_inv$intermediate,
