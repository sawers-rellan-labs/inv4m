...
saveRDS(wgcna_all, "~/Desktop/wgcna_all.rds")
...
saveRDS(wgcna_ctrl, "~/Desktop/wgcna_ctrl.rds")
saveRDS(wgcna_inv4m, "~/Desktop/wgcna_inv4m.rds")
...
write_csv(modules_all_summary, "~/Desktop/modules_all_summary.csv")
```
...
write_csv(modules_ctrl_summary, "~/Desktop/modules_ctrl_summary.csv")
write_csv(modules_inv4m_summary, "~/Desktop/modules_inv4m_summary.csv")
```
...
write_csv(hubs_all, "~/Desktop/hubs_all.csv")
write_csv(hubs_all_top, "~/Desktop/hubs_all_top.csv")
...
if (nrow(hubs_all_cis) > 0) {
  ...
  write_csv(hubs_all_cis, "~/Desktop/hubs_all_cis.csv")
}
```
...
write_csv(hubs_ctrl, "~/Desktop/hubs_ctrl.csv")
write_csv(hubs_ctrl_top, "~/Desktop/hubs_ctrl_top.csv")
write_csv(hubs_inv4m, "~/Desktop/hubs_inv4m.csv")
write_csv(hubs_inv4m_top, "~/Desktop/hubs_inv4m_top.csv")
...
if (nrow(hubs_ctrl_cis) > 0) {
  ...
  write_csv(hubs_ctrl_cis, "~/Desktop/hubs_ctrl_cis.csv")
}
...
if (nrow(hubs_inv4m_cis) > 0) {
  ...
  write_csv(hubs_inv4m_cis, "~/Desktop/hubs_inv4m_cis.csv")
}
```
...
trans_edges <- read_csv("~/Desktop/inv4m_bipartite_edges.csv")
...
write_csv(trans_edges_all, "~/Desktop/trans_modules_all.csv")
write_csv(trans_summary_all, "~/Desktop/trans_summary_all.csv")
...
write_csv(
  ...
  "~/Desktop/tom_ctrl_inv4m_order.csv"
)

write_csv(
  as.data.frame(TOM_inv4m_ordered_inv4m) %>% rownames_to_column("gene"),
  "~/Desktop/tom_inv4m_inv4m_order.csv"
)
```
...
write_csv(
  ...
  "~/Desktop/tom_ctrl_ctrl_order.csv"
)

write_csv(
  as.data.frame(TOM_inv4m_ordered_ctrl) %>% rownames_to_column("gene"),
  "~/Desktop/tom_inv4m_ctrl_order.csv"
)
