...
- **PA2022**: Pennsylvania environment (+P treatment, colder/northern)
- **NC2025**: North Carolina environment (warmer/southern)
...
cat("PA2022 dimensions:", dim(psu2022), "\n")
cat("NC2025 dimensions:", dim(cly2025), "\n")
cat("PA2022 genotypes:", unique(psu2022$genotype), "\n")
cat("NC2025 genotypes:", unique(cly2025$genotype), "\n")
cat("PA2022 treatments:", unique(psu2022$Treatment), "\n")
cat("NC2025 donors:", unique(cly2025$donor), "\n")
...
### 2.1 PA2022 High-P Environment Analysis

```{r psu2022-prep}
# Filter PA2022 to +P treatment and relevant genotypes
...
print("PA2022 High-P Results:")
print(psu2022_summary)
```

### 2.2 NC2025 MI21 Donor Analysis

```{r cly2025-prep}
# Filter NC2025 to MI21 donor and standardize genotype names
...
gxe_data <- bind_rows(
  ...
  mutate(
    genotype = factor(genotype, levels = c("CTRL", "Inv4m")),
    environment = factor(environment, levels = c("PA2022_HighP", "NC2025"))
  ) %>%
  filter(complete.cases(.))
...
env_effect_sizes <- bind_rows(
  psu2022_cohens_d %>% mutate(environment = "PA2022_HighP"),
  cly2025_cohens_d %>% mutate(environment = "NC2025")
) %>%
...
final_summary <- list(
  PA2022_HighP = psu2022_summary,
  NC2025_MI21 = cly2025_summary,
...
cat("1. PA2022 High-P:\n")
print(final_summary$PA2022_HighP)

cat("\n2. NC2025 MI21:\n")
print(final_summary$NC2025_MI21)
...
write.csv(final_summary$PA2022_HighP, "PA2022_HighP_inv4m_results.csv", row.names = FALSE)
write.csv(final_summary$NC2025_MI21, "CLY2025_MI21_inv4m_results.csv", row.names = FALSE)
...
cat("- PA2022_HighP_inv4m_results.csv\n")
