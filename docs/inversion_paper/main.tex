...
as key environmental variables, like mean annual temperature \cite{billings1968}, growing season length \cite{pisek1960}, and growing degree days \cite{pisek1960, sykes1995}, change in similar ways along elevational and latitudinal gradients \cite{halbritter2013}.
...
However, introgression of beneficial alleles from highland maize has demonstrated limited usefulness for improving temperate maize, partially because of low yield stability in temperate settings  resulting from high genotype by environment interaction \cite{giauffret200, hallauer2014, eagles1994}.

Between 18-25\% of the genome in modern maize lines is of \mex{} origin \cite{yang}.
Yet \invfour{} has not been found among genotyped US germplasm, despite being ubiquitous in Mexican highland traditional varieties \cite{crow2020}.
Above 2000~masl, \invfour carriers flower one day earlier and yield 0.4~metric tons per hectare more than non-carriers; below 1000~masl these effects reverse, delaying flowering and reducing yield \cite{crow2020}.
...
Because recombination within the inversion is suppressed \cite{gonzalez-segovia2019-jy}, these alternatives cannot yet be distinguished genetically in our NIL population.
