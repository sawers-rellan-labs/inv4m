...
The 465 \invfour DEGs  concentrated within the 39 Mb shared introgression on chromosome 4, with 97-fold enrichment relative to the rest of the genome (Table~\ref{tab:DEGs_distro}).
...
\subsection*{Genomic and functional evidence links  \jmjii copy number, growth and flowering time plasticity}
...
\subsection*{Perturbation of gene coexpression networks connects \invfour to growth regulation}
