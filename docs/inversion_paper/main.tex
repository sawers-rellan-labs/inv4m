...
At the Pennsylvania 2022 site (PA2022), spatially-corrected phenotype analysis showed that plants carrying the highland inversion allele flowered $1.30 \pm 0.27$ days earlier to anthesis ($p = 7.9 \times 10^{-6}$) and $1.05 \pm 0.22$ days earlier to silking ($p = 1.4 \times 10^{-5}$) compared to control lines.
...
SAM measurements from two-week-old seedlings showed that \invfour plants have elongated meristems, with a 9\% increase in the shape factor ($h/r^2 = +2.49 \pm 1.14$ $\mu$m$^{-1}$, $p = 0.035$; Fig~\ref{fig:phenotypes}C).
