...
genotype (Fig~\ref{fig:transcriptome}). Increased leaf stage, which correlates with 
...
\subsection{WGCNA reveals widespread coexpression network disruption in
\invfour plants}
...
previously reported limits (Fig~\ref{fig:transcriptome} C). A single gene 
...
responsive in the \invfour plant (Fig~\ref{fig:transcriptome} D).
...
\textbf{(A)} Expression of \jmjii and \jmjiv across tissues and experiments. Boxplots show $\log_2(\text{CPM})$ expression in B73 (gold) and \invfour (purple) genotypes. Left: Crow et al. (2020) growth chamber data across 10 tissue types. Right: PSU2022 field data across 4 leaf positions. Both genes show consistent downregulation in \invfour across all tissues and experimental conditions.
