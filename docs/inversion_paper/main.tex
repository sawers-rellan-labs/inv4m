...
A fourth Reference-network gene, \textit{Zm00001eb192330} ($\log_2 FC = +5.05$), carries a Borealin Pfam domain (PF10512) consistent with the Arabidopsis ortholog AT4G39630 (\textit{BORR}, Borealin-related), encoding a chromosomal passenger complex kinetochore component involved in cell division; the maize gene was provisionally labeled \textit{roc4-1} in our internal annotation and is being reannotated to reflect its Borealin identity.
...
\midrule
  ...
  \textit{Zm00001eb192330} & \textit{roc4-1} & --- & 5.05 & 3.27e-13 \\
