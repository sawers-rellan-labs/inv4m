...
Association studies have linked \invfour to variation in flowering time and yield, and growth chamber assays showed broad \invfour transcriptomic effects enriched in genes for photosynthesis and lipid synthesis in response low temperature stress.
...
Here we generated Near Isogenic Lines by introgressing an allele of \invfour from the highland Michoacan 21 (Mi21) traditional variety into the B73 background through eight generations of backcrossing and characterized the effects of \invfour on fitness, transcriptome, and gene co-expression networks in field experiments across several environments.
We assembled the genome of \invfour -Mi21 NIL and by aligning to three \textit{Zea} references we delimited \invfour, and found that the inversion breakpoints map to chromosomal knob repeat arrays.
Field experiments showed that in a northern, Pennsylvania field trial, the \invfour introgression accelerated flowering by 1.3 days and increased plant height by 6.5 cm; however, genotype-by-environment interactions across environments reversed the height effect in a southern North Carolina, consistent with environment-dependent contributions.
...
We identified 465 differentially expressed genes (DEG) by RNA-seq, with the strongest signal from a JUMONJI histone demethylase cluster that shows a lineage-specific tandem expansion in B73 (five paralogs) relative to highland genomes that only carry one copy.
