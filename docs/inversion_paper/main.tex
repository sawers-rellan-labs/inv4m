...
However, the harvest index increased ($0.11 \pm 0.04$, $p = 0.01$), suggesting that \invfour alters vegetative-reproductive resource allocation rather than promoting overall growth.
...
In maize, SAM elongation marks the acquisition of floral competence \cite{danilevskaya2008} and the end of the photoperiod-sensitive inductive phase \cite{ku2008}, and natural variation in SAM size correlates with flowering time across inbred lines \cite{leiboff2015, thompson2015}.
