...
\begin{figure*}[!ht]
\centering
\includegraphics[width=0.8\linewidth]{figs/jmjcluster.png}
...
\begin{figure}[!ht]
\includegraphics[width=\linewidth]{figs/SFig_GxE_effect_sizes_forest.png}
...
\begin{figure*}[!ht]
\centering
\includegraphics[width=\linewidth]{figs/SFig_internode.png}
...
\textbf{(B)} Representative dissected plants showing whole plant architecture, stem detail with visible nodes, and tassel structure. Scale bar in cm.
\textbf{(C)} Schematic illustration of maize plant architecture indicating internode numbering scheme from the tassel-bearing node (position 1) downward.
\textbf{(D)} Internode length profiles by position from top. Boxplots show internode length (cm) at each position for CTRL (gold, $n = 112$ plants) and \invfour (purple, $n = 116$ plants). The longest internodes occur at positions 4--6, corresponding to the ear node region.}
\label{fig::internode}
\end{figure*}
