...
subgraph (Fig~\ref{fig::DEGnetwork}A, right panel). \jmjiv ($\log_2 FC =
...
(Fig~\ref{fig::DEGnetwork}B) revealed significant over-representation of
...
including \textit{pcna2} and \textit{sec6} (Fig~\ref{fig::DEGnetwork}A),
