...
Although \invfour contains classical phosphorus starvation response (PSR) genes that might be adaptive to the volcanic soils of the Mexican highlands, we tested and rejected the hypothesis of phosphorus-mediated effects of \invfour in a companion study \cite{rodriguez2026phosphorus}.
Here we report that \invfour produces significant effects on flowering time and plant height whose magnitude and direction vary across environments (Fig~\ref{fig:phenotypes}, Supplementary Table~\ref{tab::gxe}), and identify the JMJ histone demethylase cluster as the most statistically robust signal among differentially expressed genes (Fig~\ref{fig:jmj_cluster}).
