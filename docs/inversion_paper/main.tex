...
\begin{table*}[!ht]
\caption{\textbf{Novel \invfour trans-coexpression network genes: \invfour region.}
Genes within the \invfour introgression in the dataset-specific co-expression network
(Bonferroni $< 0.001$), sorted by FDR ascending.
$\log_2$FC and FDR are from the genotype DEG analysis.}
\label{tab::novel_trans_network_inv4m}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lllrr}
\toprule
...
\midrule
  ...
  \textit{Zm00001eb190670} & \textit{zfrvt} & --- & 1.97 & 2.27e-16 \\
  ...
  \textit{Zm00001eb193120} & \textit{o3l1} & --- & 2.35 & 1.01e-07 \\
  \textit{Zm00001eb193130} & \textit{chi} & Chalcone--flavonone isomerase & -5.47 & 2.61e-07 \\
  \textit{Zm00001eb192180} & \textit{hpse3} & --- & -5.75 & 7.12e-07 \\
  ...
  \textit{Zm00001eb192470} & \textit{cdi} & --- & 3.19 & 1.86e-03 \\
...
\begin{table*}[!ht]
\caption{\textbf{Novel \invfour trans-coexpression network genes: outside introgression.}
Genes outside the \invfour introgression in the dataset-specific co-expression network
(Bonferroni $< 0.001$), sorted by FDR ascending.
$\log_2$FC and FDR are from the genotype DEG analysis.}
\label{tab::novel_trans_network_outside}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lllrr}
\toprule
\textbf{Gene ID} & \textbf{Label} & \textbf{Description} &
...
\midrule
  ...
  \textit{Zm00001eb183030} & \textit{gst} & --- & 7.84 & 2.04e-03 \\
