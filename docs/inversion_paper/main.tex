...
The histone demethylase \jmjii (\textit{Zm00001eb191790}; $\log_2 FC = -3.49$) and its paralog \textit{jmj21} (\textit{Zm00001eb190750}; $\log_2 FC = +2.28$) connect to trans targets, consistent with the flowering time and plant height effects of their orthologs in Arabidopsis and Brachypodium \cite{TODO_jmj_arabidopsis, TODO_jmj_brachypodium}.
\textit{smo4} (\textit{Zm00001eb192850}; $\log_2 FC = -1.98$), encoding the SUMO-activating enzyme E1 subunit UBA2, also appears in the Reference network; its Arabidopsis ortholog produces dwarf plants when mutated \cite{TODO_smo4_arabidopsis}.
...
\midrule
  ...
  \textit{Zm00001eb192850} & \textit{smo4} & SUMO-activating enzyme subunit uba-2 like & -1.98 & 3.14e-18 \\
