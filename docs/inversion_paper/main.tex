...
We reduced this drag from the 57 Mb observed in the BC$_5$ populations of \cite{crow2020}, and we addressed the attribution problem by applying a strongest-correlated-gene criterion in the trans coexpression network, assigning trans targets only when their strongest correlated potential regulator lies within the 15 Mb inversion proper (see Methods).
...
To identify genes regulated in \textit{trans} by \invfour, we constructed a bipartite co-expression network linking DEGs within the introgressed region (\textit{cis} potential regulators) to DEGs located elsewhere in the genome (\textit{trans} targets).
