...
% TODO: Add to Inv4m.bib:
% @article{rodriguez2026phosphorus,
%   author = {Rodr\'{i}guez-Zapata, Fausto and Stokes, Ruthie and Barnes, Allison C. and Tandukar, Nirwan and P\'{e}rez-Lim\'{o}n, Sergio and Perryman, Melanie and Pi\~{n}eros, Miguel A. and Ojeda-Rivera, Jonathan Odil\'{o}n and Runcie, Daniel and Sawers, Ruairidh and Rell\'{a}n-\'{A}lvarez, Rub\'{e}n},
%   title = {Multi-Omics of Maize Chromosomal Inversion {Inv4m} in Phosphorus Deficiency Show Typical Starvation Responses with Leaf-Age Dependency, Rather Than Adaptive Contributions From the Inverted Karyotype},
%   journal = {bioRxiv},
%   year = {2026},
%   note = {preprint},
%   doi = {10.1101/XXXX}
