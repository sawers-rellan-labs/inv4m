...
Within-genotype $-$P vs $+$P contrasts (\texttt{emmeans} \cite{lenth2023}) from Eq.~\ref{eq:pheno_model}, FDR-corrected across 48 tests, are plotted in Figure~\ref{fig:Figure_1}; marginal $\pm$P contrasts from the same model in Supplementary Figure~\ref{supp:Figure_S1}.
The same model was fit independently to each mineral $\times$ metric family combination (concentration, content, grain/stover ratio, harvest index).
Within-genotype $-$P vs $+$P ionome contrasts, FDR-corrected across 96 tests, are plotted in Figure~\ref{fig:Figure_2} and Supplementary Figure~\ref{supp:Figure_S4}.
Marginal \invfour vs CTRL ionome contrasts, FDR-corrected across 48 tests, are plotted in Supplementary Figure~\ref{supp:Figure_S5}.
